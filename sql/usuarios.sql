...
GRANT SELECT, UPDATE on tuxout.usuarios to usuario;
GRANT SELECT, INSERT, UPDATE, DELETE tuxout.usuario to backoffice;

GRANT SELECT, INSERT, UPDATE on tuxout.empresas to proveedor;
GRANT SELECT, INSERT, UPDATE, DELETE on tuxout.empresas to backoffice;
